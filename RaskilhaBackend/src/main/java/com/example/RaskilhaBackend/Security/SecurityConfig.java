    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/auth/login", "/raskilha/signup","/api/user/update", "/auth/signup","/auth/register","/auth/**","api/**", "commentaires/**","/api/pubs/region/**","api/localisations/**","api/localisations/proches").permitAll()
